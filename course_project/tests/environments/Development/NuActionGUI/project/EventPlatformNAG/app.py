...
from dtm import db, Person, VISITOR, REGULARUSER, MODERATOR, ADMIN, ANY, MARKETING, FUNCTIONAL, ANALYTICS, TARGETEDMARKETING, MASSMARKETING, RECOMMENDEVENTS, CORE,  Role, Purpose, Consent, PersonalData
