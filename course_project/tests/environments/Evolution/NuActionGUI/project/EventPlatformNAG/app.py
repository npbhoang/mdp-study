...
from dtm import db, Person, VISITOR, REGULARUSER, MODERATOR, ADMIN, ANY, MARKETING, TARGETEDMARKETING, MASSMARKETING, INSIGHTS, ANALYTICS, STATS, FUNCTIONAL, RECOMMENDEVENTS, CORE,  Role, Purpose, Consent, PersonalData
