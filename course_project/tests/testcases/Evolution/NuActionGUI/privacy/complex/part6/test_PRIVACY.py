...
# on endpoint remove_attendee() 
# Should fail
def test_case_234_remove_attendee_FUNCTIONAL(client, app_with_data):
    caller = Person.query.filter(Person.testid == 'ADMIN0').one()
    owner = Person.query.get(5)
    with app_with_data.test_request_context():
        login_user(caller)
        try:
            add_consent(owner, FUNCTIONAL, 'Person', 'attends')
        except Exception:
            assert False
        # Test remove_attendee()
        try:
...
# on endpoint remove_attendee() 
# Should fail
def test_case_235_remove_attendee_FUNCTIONAL(client, app_with_data):
    caller = Person.query.filter(Person.testid == 'ADMIN0').one()
    owner = Person.query.get(5)
    with app_with_data.test_request_context():
        login_user(caller)
...
# Should fail
def test_case_241_accept_request_FUNCTIONAL(client, app_with_data):
    caller = Person.query.filter(Person.testid == 'ADMIN0').one()
...
# on endpoint accept_request() 
# Should fail
def test_case_242_accept_request_FUNCTIONAL(client, app_with_data):
    caller = Person.query.filter(Person.testid == 'ADMIN0').one()
    owner = Person.query.get(7)
    with app_with_data.test_request_context():
        login_user(caller)
...
# on endpoint remove_attendee() 
# Should fail
def test_case_231_remove_attendee_ANY(client, app_with_data):
    caller = Person.query.filter(Person.testid == 'ADMIN0').one()
    with app_with_data.test_request_context():
        login_user(caller)
        try:
...
# on endpoint remove_attendee() 
# Should fail
def test_case_234_remove_attendee_ANY(client, app_with_data):
    caller = Person.query.filter(Person.testid == 'ADMIN0').one()
    owner = Person.query.get(5)
    with app_with_data.test_request_context():
        login_user(caller)
...
# on endpoint accept_request() 
# Should fail
def test_case_242_accept_request_ANY(client, app_with_data):
    caller = Person.query.filter(Person.testid == 'ADMIN0').one()
    owner = Person.query.get(7)
    with app_with_data.test_request_context():
        login_user(caller)
