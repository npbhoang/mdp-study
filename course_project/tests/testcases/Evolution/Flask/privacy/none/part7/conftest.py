...
def app_with_data():
    ...
    with app.app_context():
        ...
        p1.requests.append(e1)
        p1.requests.append(e2)
        p1.requests.append(e3)
        p1.requests.append(e4)
        p1.requests.append(e5)
        p1.requests.append(e6)
        p1.requests.append(e7)
        p1.requests.append(e8)
        p2.attends.append(e1)
        p2.attends.append(e2)
        p2.attends.append(e3)
        p2.attends.append(e4)
        p2.attends.append(e5)
        p2.attends.append(e6)
        p2.attends.append(e7)
        p2.attends.append(e8)
