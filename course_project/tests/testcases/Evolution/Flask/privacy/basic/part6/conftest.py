...
def app_with_data():
    ...
    with app.app_context():
        ...
        e1.attendants.append(p2)
        e1.managedBy.append(p2)
        e1.requesters.append(p3)
        e2.attendants.append(MODERATOR0)
        e2.attendants.append(p1)
        e2.managedBy.append(MODERATOR0)
        e2.attendants.append(p2)
        e2.managedBy.append(p2)
        e2.requesters.append(p3)
        e3.requesters.append(p3)
        e3.attendants.append(ADMIN0)
        e3.attendants.append(p1)
        e3.managedBy.append(ADMIN0)
        e3.attendants.append(p2)
        e3.managedBy.append(p2)
        ...
        e4.attendants.append(p2)
        e4.managedBy.append(p2)
        e4.requesters.append(p3)
        ...
        e5.attendants.append(p2)
        e5.managedBy.append(p2)
        ...
        e6.managedBy.append(p2)
        e7.attendants.append(p0)
        e7.attendants.append(p1)
        e7.managedBy.append(p0)
        e7.attendants.append(p2)
        e7.managedBy.append(p2)
        e8.attendants.append(p0)
        e8.managedBy.append(p0)
        e1.requesters.append(p1)
        e2.requesters.append(p1)
        e3.requesters.append(p1)
        e4.requesters.append(p1)
        e5.requesters.append(p3)
        e6.requesters.append(p3)
        e7.requesters.append(p3)
        e6.attendants.append(p2)
        e8.requesters.append(FREEUSER0)
        e8.requesters.append(MODERATOR0)
        e8.requesters.append(ADMIN0)
        c1.events.append(e1)
        c1.events.append(e2)
        c1.events.append(e3)
        c1.events.append(e4)
        ...
        c2.moderators.append(MODERATOR0)
